        ...
        <Wrapper>
          <CTA>
            ...
            <p>
              ...
              Architecto necessitatibus nulla voluptates unde pariatur
              exercitationem veniam adipisci ducimus rem, corporis voluptate
              illo laudantium voluptatum, similique natus enim nostrum ad
              excepturi!
            </p>
          </CTA>
          <AmountWrapper>
            ...
            <small>Click your payment method to continue</small>
            ...
            />
            <figure className="logoGrid">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="42"
                height="24"
                viewBox="0 0 42 24"
                className="PaymentLogo variant-- "
              >
                <title>Visa</title>
                <path
                  fill="var(--paymentLogoColor, #1434cb)"
              ...
              >
                ...
                <g fill="none" fillRule="evenodd">
                  <g stroke="#427FBC" strokeLinecap="square">
                    <path
                      strokeOpacity=".1"
                      d="M1003.5-6508V7929"
                      fill="var(--paymentLogoColor, null)"
                    ></path>
                    <path
                      strokeOpacity=".15"
                      strokeDasharray="3,5"
                  ...
                  <g fillRule="nonzero">
                    <path
                      ...
                      fill="var(--paymentLogoColor, #0A2540)"
                    ></path>
                    <path
                      ...
                      fill="var(--paymentLogoColor, #ED0006)"
                    ></path>
                    <path
              ...
              >
                ...
                <g fill="none" fillRule="evenodd">
                  ...
                  ></path>
                  <path
                    fill="var(--paymentLogoColor, #7673C0)"
                    fillRule="nonzero"
                    d="M8.829 5.602h6.546v11.765H8.829z"
                  ></path>
                  <path
                    fill="var(--paymentLogoColor, #EB001B)"
                    fillRule="nonzero"
                    d="M9.247 11.484a7.47 7.47 0 0 1 2.858-5.882 7.482 7.482 0 1 0 0 11.765 7.47 7.47 0 0 1-2.858-5.883z"
                  ></path>{" "}
                  <path
                    fill="var(--paymentLogoColor, #00A1DF)"
                    fillRule="nonzero"
              ...
              >
                ...
                <g fill="none" fillRule="evenodd">
                  <path
                    fill="var(--paymentLogoColor, #017ECD)"
                    fillRule="nonzero"
              ...
              >
                ...
                <defs>
                  <linearGradient id="a" x1="0%" y1="74.913%" y2="25.087%">
                    <stop offset="0%" stopColor="#00A26C"></stop>
                    <stop offset="48.682%" stopColor="#007DB5"></stop>
                    <stop offset="100%" stopColor="#003877"></stop>
                  </linearGradient>
                </defs>
                <g fill="none" fillRule="evenodd">
                  <rect width="34" height="24" fill="url(#a)" rx="3.882"></rect>
                  <path
                    fill="var(--paymentLogoColor, #FFFFFE)"
              ...
              >
                ...
                <g fill="none" fillRule="evenodd">
                  <g fillRule="nonzero">
                    <path
                      fill="var(--paymentLogoColor, #2283CB)"
              ...
              >
                ...
                <g fill="none" fillRule="evenodd">
                  ...
                  ></path>
                  <path
                    fill="var(--paymentLogoColor, #FFA201)"
                    fillRule="nonzero"
              ...
              >
                ...
                <g fill="none" fillRule="evenodd">
                  <g fillRule="nonzero">
                    <path
                      fill="var(--paymentLogoColor, #1B6BAF)"
                    ...
                    ></path>
                    <path
                      fill="var(--paymentLogoColor, #D02644)"
                    ...
                    ></path>
                    <path
                      fill="var(--paymentLogoColor, #46A548)"
              ...
              >
                ...
                <g fill="none" fillRule="evenodd">
                  ...
                  ></path>
                  <path
                    fill="var(--paymentLogoColor, #E21836)"
                    fillRule="nonzero"
                  ...
                  ></path>
                  <path
                    fill="var(--paymentLogoColor, #00447C)"
                    fillRule="nonzero"
                  ...
                  ></path>
                  <path
                    fill="var(--paymentLogoColor, #007B84)"
                    fillRule="nonzero"
                  ...
                  ></path>
                  <path
                    fill="var(--paymentLogoColor, #FEFEFE)"
                    fillRule="nonzero"
